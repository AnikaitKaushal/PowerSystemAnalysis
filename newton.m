basemva = 100;  accuracy = 0.0000001; maxiter = 50;

% Formation of Bus Admittance Matrix i.e. Y-Bus
...
clear Pgg
% disp('Y Bus for the system is:')
% disp(Ybus)


% Power Flow problem solution by Newton Raphson method
...
%  This script prints the power flow solution in a tabulated form
%  on the screen.
...
% Computation and displaying the line flow and losses
