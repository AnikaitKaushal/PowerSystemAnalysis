basemva = 100;  accuracy = 0.0000001; accel = 1.8; maxiter = 500;

% Forming the bus admittance matrix i.e. Y-Bus
...
% Load flow problem solution by Gauss-Seidel method
...
% Printing the power flow solution on the screen
